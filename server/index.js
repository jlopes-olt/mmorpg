...
io.on('connection', (socket) => {
  ...
  socket.on('housing:craftFurniture', act((d) => game.craftFurniture(player, String(d.itemId))));
  socket.on('housing:placeFurniture', act((d) => game.placeFurniture(player, String(d.itemId), Number(d.x), Number(d.y))));
  socket.on('housing:removeFurniture', act((d) => game.removeFurniture(player, Number(d.x), Number(d.y))));
